...
**byfa-cli** is licensed under the [MIT License](https://github.com/charlinchui/byfa-cli/blob/main/LICENSE). Feel free to use, modify, and distribute it according to your needs.
